package dmbdops.KafkaConponents.consumer.bdfda;
...
public class BDFDAUpdateTimeConsumer implements
    ...
    public BDFDAUpdateTimeConsumer(Properties properties, String topic, BDFDA problem){
        this.topic = topic;
