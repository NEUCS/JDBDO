...
import dmbdops.dbigopt2015.simpleUpdate.AbstractDBigOpt2015;
...
public class DBigOpt2015UpdateTime extends AbstractDBigOpt2015 {
    ...
    public DBigOpt2015UpdateTime(String instanceName) {
    ...
    private void loadData(String problemId, String fName, int dType,
            int dLength) {
        ...
        if (fName.equals("X.txt")) {
            ...
            double updateVariable = Math.abs(Math.sin(0.5 * Math.PI * time));
