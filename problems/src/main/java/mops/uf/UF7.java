...
public class UF7 extends AbstractContinuousTestProblem {
    public UF7() {
        this(30);
    }
    ...
    public void evaluate(ContinuousIndividual individual) {
        ...
        y = Math.pow(x[0], 0.2);
        individual.setObjectiveValue(0, y + 2.0 * sum1 / (double) count1);
        individual.setObjectiveValue(1, 1.0 - y + 2.0 * sum2 / (double) count2);
    }
}